...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const adress: Address = new Address(
      'Pere Perica',
      15,
      'Belgrade',
      'Serbia'
    ...
    const adress1: Address = new Address(
      'Mike Alasa',
      68,
      'Belgrade',
      'Serbia'
    ...
    const adressStefan: Address = new Address(
      'Lole Ribara',
      198,
      'Belgrade',
      'Serbia'
    ...
    const employeeMarko: Employee = new Employee(
      3,
      'Marko',
      'marko@gmail.com',
      38162555888,
    ...
    const adressUros: Address = new Address(
      'Nikole Tesle',
      65,
      'Belgrade',
      'Serbia'
